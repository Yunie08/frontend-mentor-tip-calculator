...
document.querySelectorAll("input[name='tip']").forEach((element) => {
  element.addEventListener("click", function (e) {
    if (
      ...
      customTipElt.classList.contains("inputCheck")
    ) {
...
function inputsEmpty() {
  if (
    (billInput.value == undefined || billInput.value == "") &&
    document.querySelector('input[name="tip"]:checked') == undefined &&
    (peopleInput.value == undefined || peopleInput.value == "")
  ) {
    return true;
  } else {
    return false;
...
function checkInputs() {
  if (billInput.value == undefined) {
    ...
    document.querySelector('input[name="tip"]:checked') == customTipRadio &&
    customTipRadio.value == "custom"
  ) {
    return false;
